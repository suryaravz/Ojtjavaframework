...
{
	System.setProperty("webdriver.firefox.driver", "D:\\Selenium_Evening\\ERP_STOCK\\CommonDriver\\chromedriver.exe");
...
public static void openApplication(WebDriver driver,String locatortype,String locatorvalue,String timewait)
{
	WebDriverWait mywait=new WebDriverWait(driver, Integer.parseInt(timewait));
	if(locatortype.equalsIgnoreCase("id"))
	{
	...
	public static void captureData(WebDriver driver,String locatortype,String locatorvalue)throws Throwable
	{
		...
		//write supplier num into notepad
